...
interface PaddleWebhookBillingPeriod {
  startsAt?: string;
  endsAt?: string;
}
...
interface PaddleSubscriptionPayload {
  ...
  status: string;
  currentBillingPeriod?: PaddleWebhookBillingPeriod;
...
async function handleSubscriptionCreated(data: PaddleSubscriptionPayload, env: PaddleEnv) {
...
async function handleSubscriptionUpdated(data: PaddleSubscriptionPayload, env: PaddleEnv) {
...
async function handleSubscriptionCanceled(data: PaddleSubscriptionPayload, env: PaddleEnv) {
  await getSupabase()
    .from("subscriptions")
